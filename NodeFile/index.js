...
function defaultSession() {
  ...
  return {
    ...
    settings: {
      ...
      snipe: {
        buyAmountUSD: 50, // Default buy amount for auto-sniper
        slippagePct: 15,
        priorityFee: "medium",
        // --- NEW PROPERTY ADDED HERE ---
        tokenFiltersOn: true, // Default security filters to ON
      },
...
async function buildWelcomeCard(s) {
  ...
  const lines = [
    ...
    `<b>Simulation P/L:</b> <code>${simProfitStr}</code>   <b>Uptime:</b> ${uptime}`,
    "",
